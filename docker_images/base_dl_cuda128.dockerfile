...
RUN python3 -m pip install --no-cache-dir --break-system-packages wheel && \
    ...
    python3 -m pip install --no-cache-dir --break-system-packages \
        tqdm==4.67.1 omegaconf==2.3.0 pillow==11.0.0 opencv-python==4.12.0.88 \
        scikit-image==0.25.2 albumentationsx==2.0.10 scikit-learn==1.7.1 \
        ...
        megfile==4.2.4 wandb==0.25.0 \
        einops==0.8.2 pytorch-warmup==0.2.0 pytorch-custom-utils==0.0.21 \
        ...
        x-transformers==2.16.0 timm==1.0.25
